...
{
    graphics.setIcon("data/icon/icon64.png");
    ...
    resources.loadTexture("plainBlack", "data/backgrounds/plainBlack.png");

    resources.loadSound("bounce", "data/sounds/bounce.wav");
